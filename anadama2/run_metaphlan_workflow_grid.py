...
workflow.add_task_group_gridable("metaphlan [depends[0]] --input_type [extension] > [targets[0]]", depends=in_files, targets=out_files, extension=args.input_extension,name="task1", mem=20, cores=1, time=2) #mem in MB, time in sec
